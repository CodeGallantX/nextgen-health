        ...
        <div className="flex justify-center gap-2 mb-6">
          {otp.map((value, index) => (
            <input
              ...
              placeholder="*"
              className="w-12 h-12 text-center text-lg font-semibold border-2 border-gray-300 rounded-lg focus:border-[#4D80FF] focus:outline-none"
            />
          ))}
        </div>
        <button
          ...
          <p className="text-sm text-gray-600">
            ...
            {isResendDisabled ? (
              ...
              <button
                ...
                className="text-[#4D80FF] underline font-medium"
              >
                Resend Code
              </button>
            )}
